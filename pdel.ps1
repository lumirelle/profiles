...
$SUPPORTED_PROFILE_COLLECTIONS = @(
  @{
    ...
    ignores      = @(
      ...
      "common${slash}.lintstagedrc.yaml",
      "common${slash}.markdownlint.yaml",
      "common${slash}.npmrc",
      "common${slash}commitlint.config.mjs",
      "common${slash}eslint.config.mjs",
      "common${slash}jsconfig.json",
      "common${slash}stylelint.config.mjs",
